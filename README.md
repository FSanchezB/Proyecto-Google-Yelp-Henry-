...
- Punto 1:
  ...
  Después de realizar un análisis de nuestros datos una vez que ya se limpiaron y se filtraron, se observaron algunos puntos importantes a mencionar y que sirvieron de ayuda para hacer el sistema de recomendación y de mejora. A continuación se detallan las conclusiones y puntos a destacar:
