...
- [`Datasets`](./Tablas_csv/): Carpeta con los Datasets ya trabajados para este proyecto.
- [`sentimiento`](./sentimiento/): Carpeta con el Dataset más grande de este proyecto, "reviews". 
- [`Modelo ML`](./Modelo_recomendacion/): Carpeta que contiene el script para correr el siste de recomendación además del notebook que contiene el trabajo de ML para sacar el sentimiento de las reseñas. 
